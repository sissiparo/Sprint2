...
///<<<<<<< HEAD
    ...
    //		@PathParam("startDate") Date startDate, @PathParam("endDate") Date endDate) {
//=======
   public List<BaseData> userStory7(@PathParam("startDate") Date startDate, @PathParam("endDate") Date endDate) {
    ...
    @Produces("application/json")
    public List<BaseData> userStory9(@PathParam("startDate") Date startDate, @PathParam("endDate") Date endDate) {
...
@GET
 ...
 public List<BaseData> populateDdl() {
    ...
    @Produces("application/json")
    public List<BaseData> userStory11(@PathParam("startDate") Date startDate,
 ...
 @GET
    ...
    @Produces("application/json")
    public List<BaseData> userStory12(@PathParam("startDate") Date startDate,
    		@PathParam("endDate") Date endDate) {
