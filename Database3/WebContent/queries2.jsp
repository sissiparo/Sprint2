...
<body>
	...
	<table width=100% height=570px>
		<tr ALIGN="CENTER">
			<td>
				<div class="button">
					<span class="main blue"><a href="../queries/userStory4.html">US4-event
							id/cause code</a></span> <span class="bottom green"><a href="#">EventID/Cause
							Codes for given IMSI</a></span> <span class="top green"><a href="#">Customer
							service rep</a></span>
				</div>
				<br>
			</td>
			...
			<td>
				<div class="button">
					<span class="main blue"><a
						href="../queries/userStory10.html">US10-Failure count for
							model</a></span> <span class="bottom red"><a href="#">Failures
							for model over period</a></span> <span class="top red"><a href="#">Network
			...
			<td>
				<div class="button">
					<span class="main blue"><a
						...
						class="bottom orange"><a href="#">Display imsis affected by given cause class</a></span> <span
						class="top orange"><a href="#">Support Engineer</a></span>
				</div>
				<br>
			</td>
			<td>
				<div class="button">
					<span class="main grey"><a href=""></a></span>
				</div>
				<br>
			</td>
			<td>
